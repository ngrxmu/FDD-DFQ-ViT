...
from generate_data_FDD import generate_data


def get_args_parser():
    parser = argparse.ArgumentParser(description="FDD-DFQViT", add_help=False)
...
def save_data(calibrate_data, args):
    ...
    torch.save(calibrate_data, f"calibrate_data/{args.model}.pt")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('FDD-DFQ-ViT', parents=[get_args_parser()])
